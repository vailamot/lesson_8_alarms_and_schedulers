package com.vailamot.notifications;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void updateNotification() {
        Bitmap androidImage = BitmapFactory
                .decodeResource(getResources(),R.drawable.dua);
        NotificationCompat.Builder notifyBuilder = getNotificationBuilder();
    ...
    public void updateNotification2(View view) {
        Bitmap androidImage = BitmapFactory
                .decodeResource(getResources(),R.drawable.dua);
        NotificationCompat.Builder notifyBuilder = getNotificationBuilder();
        notifyBuilder.setStyle(new NotificationCompat.InboxStyle()
                ...
                .addLine("second")
                .addLine("third")
                .setBigContentTitle("Notification Updated 2!"));
        mNotifyManager.notify(NOTIFICATION_ID, notifyBuilder.build());
    }
            ...
            if (intentAction != null) {
                ...
                switch (intentAction) {
                    case ACTION_UPDATE_NOTIFICATION:
                        toastMessage = "Update notification!";
                        // Update the notification.
                        updateNotification();
                        break;
                }
